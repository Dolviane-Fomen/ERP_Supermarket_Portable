@echo off
echo ========================================
echo RESOLUTION PING PC1 - SANS CHANGEMENT IP
echo ========================================
echo.

echo PROBLEME : PC1 ne peut pas recevoir les pings de PC2
echo SOLUTION : Configuration firewall et reseau SANS changer l'IP
echo.
...
echo.
echo Redemarrage de la carte reseau SANS changer l'IP...
...
echo 6. VERIFICATION DE LA CONFIGURATION APRES REDEMARRAGE...
echo.
echo Configuration IP apres redemarrage :
ipconfig /all
echo.

echo 7. TEST DE CONNECTIVITE...
echo.
...
echo 10. VERIFICATION DES ROUTES...
echo.
echo Table de routage :
route print
echo.

echo 11. TEST DE PING BIDIRECTIONNEL...
echo.
...
echo 4. L'IP de PC1 reste 192.168.8.10
echo.
