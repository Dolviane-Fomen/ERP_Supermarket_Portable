...
urlpatterns = [
    ...
    path('achats/generer-etat-inventaire/', views.generer_etat_inventaire, name='generer_etat_inventaire'),
    path('achats/export-etat-inventaire-excel/', views.export_etat_inventaire_excel, name='export_etat_inventaire_excel'),
    path('logo/', views.serve_logo, name='serve_logo'),
    ...
    path('financier/generer-etat-tresorerie/', views.generer_etat_tresorerie, name='generer_etat_tresorerie'),
    path('financier/export-etat-tresorerie-excel/', views.export_etat_tresorerie_excel, name='export_etat_tresorerie_excel'),
