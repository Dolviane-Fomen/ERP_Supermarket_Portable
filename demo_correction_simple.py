...
def demonstration_correction():
    ...
    print("CONCLUSION:")
    print("=" * 80)
    print("[SUCCES] La correction des quantites decimales fonctionne correctement!")
    print("[SUCCES] Les calculs de facturation sont maintenant precis!")
    print("[SUCCES] Le probleme de la virgule deplacee est resolu!")
    print()
