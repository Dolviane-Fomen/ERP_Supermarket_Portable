...
def add_defacturation_functions():
...
if __name__ == "__main__":
    ...
    success = add_defacturation_functions()
    
    if success:
        print("\n✅ Fonctions ajoutées avec succès !")
        print("\n📋 Fonctions ajoutées :")
        print("   - defacturer_vente(request, facture_id)")
        print("   - defacturer_vente_confirmation(request, facture_id)")
        print("\n🔗 URLs configurées :")
        print("   - /stock/defacturer/<int:facture_id>/ (confirmation)")
        print("   - /stock/defacturer/<int:facture_id>/confirmer/ (défacturation)")
        print("\n📄 Template créé :")
        print("   - supermarket/templates/supermarket/stock/defacturation_confirmation.html")
        print("\n🎯 Utilisation :")
        print("   1. Accédez à une facture via /stock/detail-factures/")
        print("   2. Cliquez sur 'Défacturer' pour une facture")
        print("   3. Confirmez la défacturation")
        print("   4. Les produits seront remis en stock automatiquement")
    else:
